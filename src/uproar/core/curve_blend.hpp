...
namespace tc
{
	...
	struct curve_blend
	{
		...
		decimal_t operator()(const decimal_t& v) const UPROAR_NOEXCEPT { return 0; }
	};
	...
	{
		using decimal_t = UPROAR_DECIMAL_TYPE;
		decimal_t operator()(const decimal_t& v) const UPROAR_NOEXCEPT { return cubic_curve(v); }
	};
	...
	{
		using decimal_t = UPROAR_DECIMAL_TYPE;
		decimal_t operator()(const decimal_t& v) const UPROAR_NOEXCEPT { return quintic_curve(v); }
	};
